...
namespace FileSystem
{
	...
	public:
		...
		bool isGood();
		void clear();
		void flush();              //erase data
		void close();
		static bool exists(const std::string& file);
		static bool copy(const std::string& src, const std::string& dst, bool failIfExists = false);   // make a copy
		static bool remove(const std::string& filespec);                           // remover the file
	private:
		std::string name_;
